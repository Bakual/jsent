...
$position = array($p0, $p1, $p2, $p3, $p4, $p5, $p6, $p7, $p8, $p9, $p10, $p11, $p12, $p13, $p14, $p15, $p16, '', '', '', '', '', '', '', '', $topmenuCount, $articleCount, $searchCount, $logoCount, $contenttop1, $contenttop2, $contentleft, $contentright, $contentbottom1, $contentbottom2);
...
<style type="text/css">
	...
	.jl_module h3, #jl_header h3, #jl_topmenu .jl_small h3, #jl_mainmenu_maxi ul a, #jl_mainmenu_maxi ul .separator {
		font-family: <?php echo "'".$this->params->get('googleFontFamily')."'"; ?>;
	}
	...
	.jl_center {
		...
		max-width: <?php echo $template_width; ?>;
		min-width: 150px;
	}

	body, p, td, tr, li, li span, dd, dt {
	<?php echo "font-family: ". $fontfamily .";"; ?> <?php echo "font-size: ". $fontsize .";"; ?> <?php echo "color: ". $fontcolor .";"; ?>
	}
	...
	<?php echo "color: ". $containercolor ." !important;"; ?>
	}
