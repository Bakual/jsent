...
<style type="text/css">
	...
	.jl_module h3,#jl_header h3,#jl_topmenu .jl_small h3,#jl_mainmenu_maxi ul a, #jl_mainmenu_maxi ul .separator{font-family:<?php echo "'".$this->params->get('googleFontFamily')."'"; ?>;}
	<?php } ?>
