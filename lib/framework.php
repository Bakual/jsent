...
class TemplateLayout
{
    ...
    { 
		if($path="footer") { echo '<div id="jl_footer"><div id="jl_footer_hr"><div id="jl_footer_left"><jdoc:include type="modules" name="footer" style="xhtml" /><div id="jl_copyright">Design by <a href="http://www.schefa.com" target="_blank">schefa.com</a></div></div><div id="jl_footer_right"><jdoc:include type="modules" name="footer-nav" style="xhtml" /></div></div><div class="jl_clear"></div></div>';}else{require_once 'templates/'.$template.'/layout/' . $path . '.php' ;}
    }
