...
// Allow access to custom fields using their names
$jcfields = array();
      ...
      <div class="row-fluid nav-icon">
  		...
  		<div class="span6">
      		...
      		<div>
      			...
      			<span class="muted">
      			  <?php if (!empty($jcfields['telefonnummer']->rawvalue)) : ?>
                    <a href="tel:<?php echo $jcfields['telefonnummer']->rawvalue; ?>" rel="nofollow"><?php echo $jcfields['telefonnummer']->rawvalue; ?></a>
					<br>
                  <?php endif; ?>
      			  <?php if (!empty($jcfields['email']->rawvalue)) : ?>
                    <a href="mailto:<?php echo $jcfields['email']->rawvalue; ?>"><?php echo $jcfields['email']->rawvalue; ?></a>
                  <?php endif; ?>
                </span>
    		</div>
  		</div>
